-- ============================================================================
-- Migration 006: Apply metadata filter to match_ec1121_gemi_mantenimiento_mecanico_automotriz
-- ============================================================================
-- Course table: ec1121_gemi_mantenimiento_mecanico_automotriz
-- RPC function: match_ec1121_gemi_mantenimiento_mecanico_automotriz
--
...
--
-- Backup reference: bkp/match_ec1121_gemi_mantenimiento_mecanico_automotriz.json
--
-- Change summary:
--   BEFORE: ``filter`` parameter existed in the signature but was IGNORED in WHERE.
...
-- ----------------------------------------------------------------------------
-- VERSION BACKUP (bkp/match_ec1121_gemi_mantenimiento_mecanico_automotriz.json)
-- Do not run — documentation and rollback reference only.
-- ----------------------------------------------------------------------------
/*
CREATE OR REPLACE FUNCTION public.match_ec1121_gemi_mantenimiento_mecanico_automotriz(
...
BEGIN
    ...
    FROM ec1121_gemi_mantenimiento_mecanico_automotriz t
...
COMMENT ON FUNCTION public.match_ec1121_gemi_mantenimiento_mecanico_automotriz(
    halfvec, integer, double precision, jsonb
) IS
    'Vector similarity search for ec1121_gemi_mantenimiento_mecanico_automotriz with optional metadata filter (has_topic_id, topic_id).';
...
-- WHERE p.proname = 'match_ec1121_gemi_mantenimiento_mecanico_automotriz';
--
