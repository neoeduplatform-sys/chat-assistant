-- ============================================================================
-- Migration 007: Apply metadata filter to match_ec0241_gemi_mantenimiento_industrial
-- ============================================================================
-- Course table: ec0241_gemi_mantenimiento_industrial
-- RPC function: match_ec0241_gemi_mantenimiento_industrial
--
...
--
-- Backup reference: pre-patch RPC (filter declared in signature, ignored in WHERE)
--
-- Change summary:
...
-- ----------------------------------------------------------------------------
/*
CREATE OR REPLACE FUNCTION public.match_ec0241_gemi_mantenimiento_industrial(
...
COMMENT ON FUNCTION public.match_ec0241_gemi_mantenimiento_industrial(
    halfvec, integer, double precision, jsonb
) IS
    'Vector similarity search for ec0241_gemi_mantenimiento_industrial with optional metadata filter (has_topic_id, topic_id).';
...
-- WHERE p.proname = 'match_ec0241_gemi_mantenimiento_industrial';
--
