-- ============================================================================
-- Migration 010: Apply metadata filter to match_ec1657_gemi_inteligencia_artificial
-- ============================================================================
-- Course table: ec1657_gemi_inteligencia_artificial
-- RPC function: match_ec1657_gemi_inteligencia_artificial
--
...
-- ----------------------------------------------------------------------------
/*
CREATE OR REPLACE FUNCTION public.match_ec1657_gemi_inteligencia_artificial(
...
BEGIN
    ...
    FROM public.ec1657_gemi_inteligencia_artificial t
...
COMMENT ON FUNCTION public.match_ec1657_gemi_inteligencia_artificial(
    halfvec, integer, double precision, jsonb
) IS
    'Vector similarity search for ec1657_gemi_inteligencia_artificial with optional metadata filter (has_topic_id, topic_id).';
...
-- WHERE p.proname = 'match_ec1657_gemi_inteligencia_artificial';
--
