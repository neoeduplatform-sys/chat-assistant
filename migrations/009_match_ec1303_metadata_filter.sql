-- ============================================================================
-- Migration 009: Apply metadata filter to match_ec1303_gemi_mantenimiento_sistemas_electronicos
-- ============================================================================
-- Course table: ec1303_gemi_mantenimiento_sistemas_electronicos
-- RPC function: match_ec1303_gemi_mantenimiento_sistemas_electronicos
--
...
-- ----------------------------------------------------------------------------
/*
CREATE OR REPLACE FUNCTION public.match_ec1303_gemi_mantenimiento_sistemas_electronicos(
...
BEGIN
    ...
    FROM ec1303_gemi_mantenimiento_sistemas_electronicos t
...
COMMENT ON FUNCTION public.match_ec1303_gemi_mantenimiento_sistemas_electronicos(
    halfvec, integer, double precision, jsonb
) IS
    'Vector similarity search for ec1303_gemi_mantenimiento_sistemas_electronicos with optional metadata filter (has_topic_id, topic_id).';
...
-- WHERE p.proname = 'match_ec1303_gemi_mantenimiento_sistemas_electronicos';
--
